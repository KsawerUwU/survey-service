...
Учебный проект по дисциплине «Базы и банки данных».

## Что изменено в этой версии

- исправлен запуск GraphQLView для актуальной версии Strawberry;
- добавлена рабочая главная страница сайта `/`;
- добавлена страница прохождения анкеты `/surveys/<slug>/`;
- отправка ответов с веб-страницы теперь идёт через GraphQL mutation `submitSurvey`;
- добавлена страница успешной отправки ответа;
- сохранены Django Admin и GraphiQL для администратора и отладки API.
